...
class ContentCreateUpdateView(TemplateResponseMixin, View):
    ...
    def dispatch(self, request, module_id, model_name, id=None):
        self_module = get_object_or_404(Module, id=module_id, course_owner = request.user)
    ...
    def post(self, request, module_id, model_name, id=None):
        ...
        if form.is_valid():
            ...
            return redirect('module_content_list', self.moule.id)
        return self.render_to_resonse({'form':form, 'object':self.obj})
